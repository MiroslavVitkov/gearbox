...
The module is limitted to be select among the standard modules: %TODO
...
$$ CD_1 = (m_{11} * z_{11} + m_{21} * z_{21}) / 2 = $$ % TODO: how to denote center distance TODO: express as ratio, not on one line TODO: calculate
\\
